...
const StudentPage = () => {
  ...
  return (
    <div className="min-h-screen  text-gray-100 p-6">
      <h1 className="text-3xl font-bold mb-6 mt-40">Behavior and Attendance for {teacherName}</h1>

      <div className="bg-gray-800 shadow-lg rounded-lg mb-6">
        <h2 className="text-2xl font-semibold text-gray-300 p-4 border-b border-gray-700">Behavior Data</h2>
